...
declare module 'wix-seo-frontend' {
    ...
    /**
     * Adds SEO-related link tags to the page.
     * 	[Read more](https://www.wix.com/corvid/reference/wix-seo-frontend.html#addLinks)
     */
    function addLinks(links: Link[]): Promise<void>;
    /**
    ...
    /**
     * Adds SEO-related meta tags to the page.
     * 	[Read more](https://www.wix.com/corvid/reference/wix-seo-frontend.html#addMetaTags)
     */
    function addMetaTags(metaTags: MetaTag[]): Promise<void>;
    /**
